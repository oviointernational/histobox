...
-- Allow anonymous / unregistered access to attendance and attendance_attendees for registration & marking links
...
drop policy if exists "anon_select_attendance_attendees" on attendance_attendees;
create policy "anon_select_attendance_attendees" on attendance_attendees for select to anon using (true);

drop policy if exists "anon_insert_attendance_attendees" on attendance_attendees;
create policy "anon_insert_attendance_attendees" on attendance_attendees for insert to anon with check (true);

drop policy if exists "anon_update_attendance_attendees" on attendance_attendees;
create policy "anon_update_attendance_attendees" on attendance_attendees for update to anon using (true);
